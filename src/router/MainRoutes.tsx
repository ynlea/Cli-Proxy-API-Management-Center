...
const mainRoutes = [
  ...
  { path: '/request-logs', element: <Navigate to="/monitor?tab=request-logs" replace /> },
  { path: '/trends', element: <Navigate to="/monitor?tab=trends" replace /> },
  { path: '/channels', element: <Navigate to="/monitor?tab=channels" replace /> },
  { path: '/costs', element: <Navigate to="/monitor?tab=costs" replace /> },
